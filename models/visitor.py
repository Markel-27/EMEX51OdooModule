...
#anadiremos atributos extra que necesitamos para nuestro modulo
    ...
    requestedVisitDate = fields.Date(string = "Fecha peticion visita", domain="[('id','!=',id),('visitDate', '&lt;', requestedVisitDate)]")
    visitReply = fields.Boolean(string = "Respuesta a peticion")
    visited = fields.Boolean(string = "Visitado")
    visitDate = fields.Date(string = "Fecha visita",  domain="[('id','!=',id),('requestedVisitDate', '&gt;', visitDate)]")
